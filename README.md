...
Прошивка для ESP32-S3 устройства ENTime: старт/финиш модули для точной фиксации событий, синхронизация времени по GPS PPS/RTC (с INA219 для мониторинга питания) и управление через JSON-команды по Serial/BLE.
