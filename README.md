...
Роль устройства задается настройкой `device.type` (см. `doc/SETTINGS.md`):
...
Подробный формат пакетов и правила отправки — в `doc/PROTOCOL.md`.
...
- ESP32-S3 DevKitC (см. [BOM.md](doc/BOM.md) для полной конфигурации)
