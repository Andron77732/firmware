...
- [ ] При сохранении новых значений в конфиг обновлять текущие значения
- [ ] При изменении некоторых значений рекомендовать перезагрузку для вступления изменений в силу
- [ ] При загрузке использовать значения из конфига
- [x] Вынести NTP сервера из дефайнов в настройки
- [ ] Добавить в ответ `sync_ntp` список используемых NTP серверов
